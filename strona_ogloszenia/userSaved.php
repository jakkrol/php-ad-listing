      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" aria-current="page" href="#">Zapisane</a></li>
...
<div class="MainContainer container-fluid row">
    ...
    $query="SELECT * FROM ogloszenie as o JOIN zapisane as z WHERE z.ogloszenie_id = o.Id AND z.user_id = $user_id";
    $result=$connect->query($query);
    while($row = $result->fetch_object()){
    echo <<< html
    
        <div class="box col-12">
        <form method="POST" action="savedCheckAdvert.php">
            <p class="title">$row->stanowisko</p>
            <p class="firma">$row->firma</p>
            <p class="adres">$row->adres_firmy</p>
            <hr>
            <button type="submit" value='$row->ogloszenie_id' name="ogloszenie">Zobacz</button>
        </form>     
        </div>
